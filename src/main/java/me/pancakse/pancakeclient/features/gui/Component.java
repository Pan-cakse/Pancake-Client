...
import me.pancakse.pancakeclient.features.gui.items.buttons.Button;
...
public class Component
    ...
    public void drawScreen(DrawContext context, int mouseX, int mouseY, float partialTicks) {
        ...
        drawString(this.getName(), (float) this.x + 3.0f, (float) this.y - 4.0f - (float) PancakeClientGui.getClickGui().getTextOffset(), -1);
        if (this.open) {
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        if (mouseButton == 0 && this.isHovering(mouseX, mouseY)) {
            ...
            PancakeClientGui.getClickGui().getComponents().forEach(component -> {
                if (component.drag) {
