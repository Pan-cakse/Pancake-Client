package me.pancakse.pancakeclient.features.modules;
...
import me.pancakse.pancakeclient.manager.ConfigManager;
...
public class Module extends Feature implements Jsonable {
    ...
    public void setDisplayName(String name) {
        Module module = PancakeClient.moduleManager.getModuleByDisplayName(name);
        Module originalModule = PancakeClient.moduleManager.getModuleByName(name);
